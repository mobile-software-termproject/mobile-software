...
public class DietInformation extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (cursor != null&& cursor.moveToFirst()) {
            ...
            displayDietDetails(imageData, dietName, date, time, cost, restaurant,review,id);
        }
    ...
    private void displayDietDetails(byte[] imageData, String dietName, String date, String time,
                                    String cost, String restaurant, String review,long dietId) {
        // Display data in the UI
        ...
        caloriesTextView.setText(""+calculateCalories(dietId));
